        ...
        exports.fn.imageDialog = function () {
            ...
            if (editor.find("." + dialogName).length < 1) {
                ...
                fileInput.bind("change", function () {
                    ...
                    //#region EEDC ajax upload image function
                    var imgForm = new FormData();
                    imgForm.append('file', fileInput.get(0).files[0]);
                    ...
                    $.ajax({
                        ...
                        beforeSend: function (request) {
                            request.setRequestHeader("Authorization", "Bearer " + JSON.parse(localStorage.getItem("_token")).token);
                        },
                        success: function (data) {
                            loading(false);

                            if (data.success) {
                                dialog.find("[data-url]").val(data.resultBody.fileUri);
                            } else {
