...
import com.graze.pastoral.notes.domain.file.FileException;
 ...
 * @Author: EEDC
 * @Description:
 * @Date: create in 2020/6/17 10:50
 */
@Service
...
//        String fileName = StringUtils.cleanPath(file.getOriginalFilename());
        String fileName = StringUtils.cleanPath(UUID.randomUUID() + getFileSuffix(file));
